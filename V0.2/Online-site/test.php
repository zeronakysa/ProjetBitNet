	...
	<div class="tab-content">
		<div class="tab-pane active" id="tab1">
			<form method="post" action="test.php?test=1">
				<input type="text" name="nameFile" id="nameFile" placeholder="Nom fichier (55 caractères maximum)" maxlength="55" required="required"><br />
				<input type="text" name="extFile" id="extFile" placeholder="Extension fichier (5 caractères maximum)" maxlength="5" required="required"><br />
			...
			function createFile($pathName){
				...
				if(isset($_GET["test"])){
					...
					chdir('..\\PROJETS\\'.$nameProject["ID_createur"].'\\'.$nameProject["nom_projet"].'\\');
