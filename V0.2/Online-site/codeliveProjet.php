<?php
	...
	//si l'id n'existe pas on ne rentre pas sur la page
	if ($_GET['id_fichier'] == null) {
		die('Accès à cette page non autorisé!');
	}
	...
	<body>
		...
		<div id="footer_menu">
			...
			<div class="options">
				...
				<input id="id_fichier" type="hidden" value="<?php echo $_GET['id_fichier'] ?>">
				<span id="saved"></span>
			</div>
		</div>
		...
		<script src="js/codeliveProjet.js"></script>
